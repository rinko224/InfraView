...
class MainUI(QMainWindow):
    ...
    def show_about_dialog(self):
        ...
        msg.setText(
            """
             <b>InfraView 热成像分析系统</b><br><br>
             版本：1.0.0<br><br>
             作者：罗佳勇 林子杰 余承恩 贺卓男<br><br>
            """
        )
        msg.exec_()
    ...
    def show_help_dialog(self):
        ...
        msg.setText(
            """
            <b>【摄像头驱动说明】</b><br><br>
            本程序通过 USB 底层接口与摄像头通信，使用 pyusb + libusbK 驱动。<br><br>

            <b>在首次使用前，请注意以下事项：</b><br><br>

            1. 需要为摄像头安装 <b>libusbK</b> 驱动<br>
            Windows 默认的摄像头（UVC）驱动无法被本程序使用。<br><br>

            2. 安装 libusbK 后：<br>
             • 摄像头将不再被系统识别为普通摄像头<br>
            • 无法在 相机 / 微信 / Zoom 等软件中使用<br><br>

            3. 驱动安装方法（推荐）：<br>
            • 下载并运行 Zadig 工具<br>
            • 选择对应的 USB 摄像头设备<br>
            • Driver 选择 libusbK<br>
            • 点击 Install Driver<br><br>

            Zadig 官方地址：
            <a href="https://zadig.akeo.ie/">https://zadig.akeo.ie/</a><br><br>

            4. 如需恢复为普通摄像头，只需在设备管理器中卸载驱动并重新插入设备即可。
            """
        )
